...
export default function NuevaHistoria({ userId, onClose, onSuccess }: Props) {
  ...
  function handleZoomChange(newZoom: number) {
    const clamped = Math.max(1, Math.min(6, newZoom))
    setZoom(clamped)
  ...
  return (
    ...
    >
      ...
      >
        ...
        {!preview && (
          <div className="flex flex-col gap-2">
            <button
              ...
              className="w-full py-8 rounded-xl text-sm transition-opacity hover:opacity-70"
            ...
            >
              <Camera size={16} /> Usar cámara (foto, video o boomerang)
            </button>
          </div>
        )}
          ...
          <div className="mb-2">
            ...
            <div className="flex items-center gap-2 mt-3 px-1">
              ...
              <input
                ...
                style={{ width: '100%' }}
              />
              <span className="text-xs" style={{ color: 'var(--text-subtle)', minWidth: '32px', textAlign: 'right' }}>
                {zoom.toFixed(1)}x
              </span>
            </div>
        ...
        {preview && isVideo && (
          <div className="mb-2">
            <div style={{ borderRadius: '12px', overflow: 'hidden', marginBottom: '10px', maxHeight: '400px' }}>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 text-sm py-2 rounded-lg transition-opacity hover:opacity-70"
