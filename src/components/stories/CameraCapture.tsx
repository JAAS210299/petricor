...
const BOOMERANG_DURATION_MS = 3000
...
export default function CameraCapture({ onCapture, onClose }: Props) {
  ...
  return (
    <div
      ...
      style={{ position: 'fixed', inset: 0, zIndex: 250, background: 'black', display: 'flex', flexDirection: 'column' }}
    >
      {/* Cabecera */}
      ...
      <div style={{ flex: 1, position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
        ...
        {recording && (
          <div style={{ position: 'absolute', top: '16px', left: '50%', transform: 'translateX(-50%)', background: '#ef4444', color: 'white', fontSize: '12px', padding: '4px 12px', borderRadius: '20px', display: 'flex', alignItems: 'center', gap: '6px', fontVariantNumeric: 'tabular-nums' }}>
